...
import { AdminLocationSuggestionStatus } from '@/modules/admin-location-suggestions';
...
type StatusPillProps = HTMLAttributes<HTMLSpanElement> & {
  status: StatusType | AdminLocationSuggestionStatus;
};

const statusStyles: Record<StatusType | AdminLocationSuggestionStatus, string> =
  {
...
const statusLabels: Record<StatusType | AdminLocationSuggestionStatus, string> =
  {
    active: 'Active',
    inactive: 'Inactive',
    pending: 'Pending',
