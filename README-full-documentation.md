...
flowchart LR
    ...
    User -->|Interacts with system| FE

    FE -->|HTTP Request / REST API| API
    API -->|JSON Response| FE

    API -->|CRUD Operations| DB
    DB -->|Stored Data / Query Results| API

    FE -->|Map Rendering / Geolocation / Place Search| MAP
    MAP -->|Map Data / Coordinates / Place Results| FE
```
...
erDiagram
    ...
    LOCATION_MATERIAL_TYPE {
        bigint waste_collection_location_id PK, FK
        bigint material_type_id PK, FK
        timestamp created_at
        timestamp updated_at
    }
    ...
    MATERIAL_TYPES ||--o{ LOCATION_MATERIAL_TYPE : assigned_to

    LOCATION_SUGGESTIONS ||--o| WASTE_COLLECTION_LOCATIONS : creates_when_approved
```
